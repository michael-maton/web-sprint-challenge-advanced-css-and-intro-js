...
//   const returnArray = [];
//   const yearsArray = [];
//   const upperLimit = century*10;
//   const lowerLimit = upperLimit-100;
//   for (i = 0; i < array.length; i++){
//     parseInt(array[i].years.split(" "))
//   }
// }

// function get20s(array, century){
//   const returnArray = [];
//   const upperLimit = century*100;
//   const lowerLimit = upperLimit-100;
//   for (let i = 0; i < array.length; i++){
//     let death = parseInt(array[i].years.split("-").pop());
//     let birth = parseInt(array[i].years.split(" "));
//     if (birth >= lowerLimit && death <= upperLimit)
//     {
...
// console.log(parseInt(artists[2].years));
// console.log(parseInt(artists[2].years.split("-").pop()));
...
addArtist(artists, 20, "Mike", "1995 - current day", "microsoft paint", "American", "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Esse error ipsam et voluptas ad libero commodi, iusto quasi accusamus sit, illo dolore quod nostrum voluptatum? Obcaecati magnam aspernatur debitis atque?", "non", 124 );
